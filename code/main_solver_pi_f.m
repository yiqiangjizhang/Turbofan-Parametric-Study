...
pi_f = 1.2:0.01:2.03; % Fan pressure ratio
pi_lpc = 4;         % LPC pressure ratio
pi_hpc = 8.5;       % HPC pressure ratio
Tt4 = 1450;         % Inlet turbine temperature [K]

F_spec_vector = zeros(1,length( pi_f)); % Specific thrust vector
I_sp_vector = zeros(1,length(pi_f));    % Specific impulse vector
...
for i = 1:length(pi_f)
    ...
    [f,T,P,U9,U1_9,M9,M1_9,F_spec_p,F_spec_s,F_spec_total,c_s,I_sp] = ...
        solver(M0,altitude,Tt4,alpha,pi_f(i),pi_lpc,pi_hpc);
    % Obtain parameters
