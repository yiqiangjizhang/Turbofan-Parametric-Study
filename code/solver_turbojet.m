% Solves turbojet given the input values

function [f,T,P,U9,U1_9,M9,M1_9,F_spec_total,c_s,I_sp] = solver_turbojet(M0,altitude,Tt4,alpha,pi_f,pi_lpc,pi_hpc)
...
%     U1_9=sqrt(gamma_c*Rg*T1_9)*M1_9;
    ...
    tau_lpt = 1-(1/(eta_ml*tau_hpt))*(Cpc/Cpt)*(Tt0/Tt4)*(1/(1+f))*((tau_lpc-1));%[Low pressure turbine's temperature ratio]
...
F_spec_total = (1+f)*U9 - U0 + ((1+f)*Rg*T9)/U9 * (1-P0/P9);
